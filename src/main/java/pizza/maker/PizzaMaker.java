...
import static pizza.maker.entity.factory.PizzaFactory.createPizza;
...
public final class PizzaMaker {
    ...
    private static void makePizza() {
        try {
            ...
            switch (choice) {
                case 1:
                    pizza = createPizza("American pizza");
                    break;
                case 2:
                    pizza = createPizza("Italian pizza");
                    break;
                case 3:
                    pizza = createPizza("Asian pizza");
                    break;
                default:
                    throw new IllegalArgumentException("Invalid choice");
            }
